...
+ Funcionalidades del compañero {#coworker}
  ...
  + [Personalizar contenido de correo electrónico por persona](./agents/personalize-content.md)
...
+ Gestión de marketing {#marketing-management}
  ...
  + Canal de seminario web {#webinar-channel}
    + [Información general](./marketing/webinars-overview.md)
...
+ Informes {#reports}
  ...
  + [Conjuntos de datos Experience Platform](./reports/aep-datasets.md)
+ Públicos {#audiences}
  ...
  + [Configuración del modelo por intención](./audiences/intent-configuration.md)
...
+ [Puntuación de Studio](./labs/scoring-studio.md)
