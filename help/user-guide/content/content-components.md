...
description: 'Diseñe correos electrónicos, páginas de aterrizaje y fragmentos con componentes de contenido: añada botones, texto, imágenes, formularios y contenedores en Marketo Optimizer.'
...
1. Establezca **[!UICONTROL Type]** para el vínculo:
   ...
   * **Página de aterrizaje**: elija este tipo para seleccionar una página de aterrizaje publicada en <!-- Journey Optimizer B2B Edition (_Beta_) or -->la instancia de Marketo Engage conectada.
     ...
     Para la opción **[!UICONTROL Página de aterrizaje]**, seleccione la página de aterrizaje publicada. Haga clic en el icono _Seleccionar página_ ( ![Mostrar icono de vínculos](../assets/do-not-localize/icon-landing-page-select.svg) ) y [seleccione la página de aterrizaje publicada](./landing-pages.md#link-to-landing-page).
...
* **[!UICONTROL Seleccionar recurso]**: elija este tipo para examinar y seleccionar un recurso de imagen de la biblioteca de Assets [!DNL Marketo Optimizer].
...
* **[!UICONTROL Importar medios]**: elija este tipo para seleccionar un archivo de su sistema e importarlo a la biblioteca de recursos [!DNL Marketo Optimizer].
  ...
  ![Importar un archivo de imagen a la biblioteca de recursos](assets/email-designer-image-upload.png){width="450"}
...
1. Establezca **[!UICONTROL Type]** para el vínculo:
   ...
   * **[!UICONTROL Vínculo externo]**: elija este tipo para usar una dirección URL estándar como destino del vínculo.
     ...
     ![Definir un vínculo externo para un componente de imagen](assets/component-button-link-options-external.png){width="250"}

   * **Página de aterrizaje**: elija este tipo para seleccionar una página de aterrizaje publicada en <!-- Journey Optimizer B2B Edition (_Beta_) or -->la instancia de Marketo Engage conectada.

     Para la opción **[!UICONTROL Página de aterrizaje]**, seleccione la página de aterrizaje publicada. Haga clic en el icono _Seleccionar página_ ( ![Mostrar icono de vínculos](../assets/do-not-localize/icon-landing-page-select.svg) ) y [seleccione la página de aterrizaje publicada](./landing-pages.md#link-to-landing-page).

     ![Definir un vínculo a una página de aterrizaje para un componente de imagen](assets/component-button-link-options-landing-page.png){width="250"}
...
1. Haga clic en la herramienta _Formulario_ en la barra de herramientas de componentes, o use las propiedades de **[!UICONTROL Incrustar formulario]** a la derecha para seleccionar el formulario publicado.
   ...
   ![Seleccionar el formulario publicado](assets/content-design-add-form-properties.png){width="600"}
...
1. Si desea anular el **[!UICONTROL tipo de seguimiento]** predeterminado del formulario, cambie la configuración según los requisitos de la página o plantilla.
   ...
   * **[!UICONTROL Página de aterrizaje]**: elija esta opción para seleccionar cualquier [!DNL Marketo Optimizer] o página de aterrizaje de Marketo Engage como seguimiento.
   ...
   * **[!UICONTROL Dirección URL externa]**: elija esta opción para especificar cualquier dirección URL como página de seguimiento. Una vez que el visitante envía el formulario, el explorador carga la dirección URL designada.
     ...
     ![Cambiar la configuración de seguimiento](assets/content-design-add-form-follow-up.png){width="280"}
