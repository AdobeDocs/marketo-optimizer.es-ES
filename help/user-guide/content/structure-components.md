...
description: Utilice componentes de estructura para correos electrónicos, páginas de aterrizaje y diseños de fragmento. Arrastre columnas, establezca estilos y configure la visualización móvil en Marketo Optimizer.
...
![Arrastrar una estructura al lienzo](assets/content-design-add-structure.png){width="800" zoomable="yes"}
...
| ---- | ---- | ----- |
| ![Habilitar contenido condicional](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Habilitar contenido condicional | (Correos electrónicos y fragmentos) Habilite variantes condicionales para el componente. |
...
![Opciones de visualización para el componente de estructura](assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![No apilar columnas en dispositivos móviles](assets/structure-component-settings-stack-columns.png){width="250"}
...
![Selector de color de fondo](assets/content-components-styles-background-color.png){width="300"}
...
![Configuración de imagen de fondo del componente de estructura con selector de recursos](assets/structure-components-background-image-settings.png){width="250"}
...
![Vista previa de ubicación de imagen de fondo en un componente de estructura](assets/structure-component-styles-background-image.png){width="250"}
...
| ![Habilitar contenido condicional](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Habilitar contenido condicional | (Correos electrónicos y fragmentos) Habilite variantes condicionales para la columna. |
...
* **[!UICONTROL Imagen de fondo]** - Mueva el selector de alternancia para habilitar la configuración de la imagen de fondo.
  ...
  ![Configuración de imagen de fondo de columna en el panel Estilos](assets/structure-components-background-image-settings.png){width="250"}
...
![Acceder a las capas de contenido](assets/content-design-layers.png){width="800" zoomable="yes"}
...
![Componentes de columna mostrados en el espacio de diseño visual](assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
